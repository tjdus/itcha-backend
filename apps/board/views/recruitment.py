...
class RecruitmentListView(APIView):
    ...
    def get_queryset(self):
        queryset = Recruitment.objects.prefetch_related('recruitment_field_set', 'application_set').select_related('created_by', 'updated_by').all()
        return queryset
...
class RecruitmentDetailView(APIView):
    ...
    def patch(self, request, pk):
        ...
        if serializer.is_valid():
            ...
            return Response(RecruitmentDetailSerializer(instance).data, status=status.HTTP_200_OK)
