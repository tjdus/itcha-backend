...
class RecruitmentField(TimestampedModel):
    recruitment = models.ForeignKey('Recruitment', on_delete=models.CASCADE, related_name="recruitment_field_set", related_query_name="recruitment_field")
    field = models.ForeignKey('Field', on_delete=models.CASCADE, related_name="recruitment_field_set", related_query_name="recruitment_field")
